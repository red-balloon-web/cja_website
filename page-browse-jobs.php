 ...
 * In order to sort by distance from the user a custom query is not enough. We have to query the database into an array with ID and distance and then loop through as there is no way to sort the custom query by the result of the distance function.
 * 
 * 1. Job Search Form
