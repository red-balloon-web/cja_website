		...
		<main id="main" class="site-main" role="main"><?php
			...
			if ($cja_current_user_obj->role == 'jobseeker') {
				...
				<div class="application-filter-options">
					<form action="<?php echo get_site_url() ?>/applications-courses" method="get">
						<p>Show: 
			 ...
			 */
				...
				if (!$_GET['advert_id']) { ?>
					...
					if ($query->have_posts()) {
						while ($query->have_posts()) {
							...
							<div class="cja_list_item">
								<a href="<?php echo get_site_url(); ?>/applications-courses?advert_id=<?php echo $cja_advert->id; ?>" class="cja_icon"><i class="fas fa-eye cja_tooltip"><div class="tooltiptext">view applications</div></i></a>
					...
					<p><a href="<?php echo get_site_url(); ?>/applications-courses"><< Back to my course applications</a></p>
