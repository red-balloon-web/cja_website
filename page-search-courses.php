...
get_header(); ?>
	...
	if (is_user_logged_in()) {
		...
		$search_type = 'course'; // to trigger correct sections in includes
		...
		include 'inc/searches/display-search-form-courses.php';
		...
		if ($display_search) {
			...
			include 'inc/searches/create_csv_array_courses.php';
