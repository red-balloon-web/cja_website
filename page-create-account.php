			...
			if (current_user_can('administrator')) {
				...
				<div class="new-user-account">
					...
					<form action="<?php echo $pageaddress; ?>" method="POST">
						...
						<p class="account-choice"><input type="radio" name="role" value="jobseeker"> <strong>Job or Course Seeker Account</strong> - I want to apply for jobs or courses</p>
						<input type="submit">
					</form>
				</div> <?php
			} else {
				echo '<p>You need to be an administrator to view this page</p>';
			} ?>
