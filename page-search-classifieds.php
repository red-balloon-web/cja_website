	...
	<div id="primary" class="content-area">
		...
		if ($display_search) {
			...
			// Otherwise populate from cookies
				...
				$cja_classifiedsearch->update_from_cookies(); // search criteria in $_POST are already stored as cookies on the init hook
			}

			// print_r($cja_classifiedsearch);
			// $cja_coursesearch->max_distance = 30; // testing
			 ...
			 */
				...
				// print_r($cja_classifiedsearch->build_wp_query());
