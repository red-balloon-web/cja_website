...
if ($_GET['edit-search']) { 
    $cja_coursesearch = new CJA_Course_Advert; // for persistent search using cookies
    ...
    <form action="<?php echo get_the_permalink(); ?>" method="post" id="edit_course_search_form" class="smart_form">
        ...
        <h2 class="form_section_heading">About The Courses You're Looking For</h2>
