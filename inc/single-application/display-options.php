...
if ($cja_current_user_obj->role == 'jobseeker') {
    if (!$cja_current_application->applicant_archived) {
        ...
        <p><a href="<?php echo get_site_url() . '/' . $cja_config['applications-page-slug']; ?>?applicant_archive=<?php echo $cja_current_application->id; ?>" class="cja_button">Archive this Application</a></p>
        <?php
    } else {
